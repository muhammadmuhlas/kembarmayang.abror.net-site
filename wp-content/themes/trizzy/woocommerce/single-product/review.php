...
<?php if ( $rating && get_option( 'woocommerce_enable_review_rating' ) == 'yes' ) :
	...
	<div itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating" class="star-rating" title="<?php echo sprintf( __( 'Rated %d out of 5', 'trizzy' ), $rating ) ?>">
		...
		<div class="rating <?php echo $avclass; ?>"><div class="star-rating"></div><div class="star-bg"></div>
		<span><strong itemprop="ratingValue"><?php echo esc_attr( $rating ); ?></strong> <?php esc_attr_e( 'out of 5', 'woocommerce' ); ?></span></div>
	</div>
<?php endif; ?>
			</div>
